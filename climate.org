...
absorption peak at \unit{4.24}{\micro\metre} (or, in the cgs units
used by the code, \unit{150}{\centi\reciprocal\metre} around
\unit{2361}{\centi\reciprocal\metre}) with the other parameter values
...
#+BEGIN_SRC sh :session *bash* :results none :eval never
  ...
  ./lm_calc
  mv ABSCO_HIT2020.dat ../cache/hitran_lm_2350.dat
  cd ..
#+END_SRC

And here is a plot of the results
#+BEGIN_SRC R :file output/hitran_2350.pdf
  hitran_2350 <- read.table("cache/hitran_lm_2350.dat",
...
Let's use the strongest absorption band (around
\unit{2340}{\centi\reciprocal\metre}) and retain the other parameters
as already used previously.
