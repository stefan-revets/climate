...
*** Boron basics
The standard composition of boron is given by IUPAC (2003) as
| isotope         | proportion |
|-----------------+------------|
| \isotope{10}{B} |   0.199(7) |
| \isotope{11}{B} |   0.801(7) |
yielding an overall atomic mass of 10.811(7)

An isotopic standard has been prepared and certified by NIST
...
\begin{equation}
\delta\isotope{11}{B} = \Bigg(\Bigg( \bigg(\frac{\isotope{11}{B}}{\isotope{10}{B}}\bigg)_{\mathrm{sample}} / 
\bigg(\frac{\isotope{11}{B}}{\isotope{10}{B}}\bigg)_{\mathrm{ref}}\Bigg) -1 \Bigg) 1000
\end{equation}
and expressed in \permil

Standard Mean composition of seawater \citep{dickson-goyet94:co2-seawater}
...
orthoborate ion, with the reaction
\begin{equation}
