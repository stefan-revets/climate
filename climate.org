...
#+BEGIN_SRC R :file output/boron_pKB.pdf
  lnKB <- function(T, S = 35.0){
      (-8966.9 - 2890.53 * sqrt(S) - 77.942 * S + 1.728 * S^(3/2) - 0.0996 *
                                                            S^2) / T +
      (148.0248 + 137.1942 * sqrt(S) + 1.62142 * S) +
          (-24.4344 -25.085 * sqrt(S) - 0.2474 * S) * log(T) + 0.053105 * T *
      sqrt(S)
  }
...
\begin{equation}
\mathrm{K}_{\isotope{11-10}{B}} = \frac{\mathrm{K}_{\isotope{11}{B}}}{\mathrm{K}_{\isotope{10}{B}}}
\end{equation}
...
\begin{equation}
\begin{split}
\mathrm{K}_{\isotope{10}{B}} & = \mathrm{K}_{\mathrm{B}} \frac{1}{R_{10} + R_{11} \mathrm{K}_{\isotope{11-10}{B}}} \\
\mathrm{K}_{\isotope{11}{B}} & = \mathrm{K}_{\mathrm{B}} \frac{\mathrm{K}_{\isotope{11-10}{B}}}{R_{10} + R_{11} \mathrm{K}_{\isotope{11-10}{B}}}
\end{split}
\end{equation}

Let's check this one out
#+BEGIN_SRC R :file output/borate_fractionation.pdf
  #K11_10 <- 1/1.019                     # Kakihana et al., 1977 value
  K11_10 <- 1/1.0272                     # Klochcko et al., 2006 value
  ...
  K_10B <- 1 / (B10_sea + B11_sea * K11_10)
  K_11B <- K11_10 / (B10_sea + B11_sea * K11_10)
